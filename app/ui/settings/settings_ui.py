...
class SettingsPageUI(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.supported_translators = [
            ...
            self.tr("AIStudio-3.1-Pro"),
            self.tr("AIStudio-3.1-Pro-Minimal"),
            self.tr("AIStudio-3.1-Pro-Low"),
            self.tr("AIStudio-3.1-Pro-Medium"),
            self.tr("AIStudio-3.1-Pro-High"),
            self.tr("AIStudio-3.1-Flash-Lite"),
            self.tr("AIStudio-3.1-Flash-Lite-Minimal"),
            self.tr("AIStudio-3.1-Flash-Lite-Low"),
            self.tr("AIStudio-3.1-Flash-Lite-Medium"),
            self.tr("AIStudio-3.1-Flash-Lite-High"),
        ...
        self.value_mappings = {
            ...
            self.tr("AIStudio-3.1-Pro"): "AIStudio-3.1-Pro",
            self.tr("AIStudio-3.1-Pro-Minimal"): "AIStudio-3.1-Pro-Minimal",
            self.tr("AIStudio-3.1-Pro-Low"): "AIStudio-3.1-Pro-Low",
            self.tr("AIStudio-3.1-Pro-Medium"): "AIStudio-3.1-Pro-Medium",
            self.tr("AIStudio-3.1-Pro-High"): "AIStudio-3.1-Pro-High",
            self.tr("AIStudio-3.1-Flash-Lite"): "AIStudio-3.1-Flash-Lite",
            self.tr("AIStudio-3.1-Flash-Lite-Minimal"): "AIStudio-3.1-Flash-Lite-Minimal",
            self.tr("AIStudio-3.1-Flash-Lite-Low"): "AIStudio-3.1-Flash-Lite-Low",
            self.tr("AIStudio-3.1-Flash-Lite-Medium"): "AIStudio-3.1-Flash-Lite-Medium",
            self.tr("AIStudio-3.1-Flash-Lite-High"): "AIStudio-3.1-Flash-Lite-High",
