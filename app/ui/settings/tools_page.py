...
class ToolsPage(QtWidgets.QWidget):
    def __init__(
        ...
        # Mask Dilation Setting
        dilation_layout = QtWidgets.QHBoxLayout()
        dilation_label = MLabel(self.tr("Mask Dilation:"))
        dilation_label.setToolTip(self.tr("Adjusts how much the text mask is expanded. Increase this if black spots or text traces remain."))
        self.dilation_spinbox = MSpinBox().small()
        self.dilation_spinbox.setFixedWidth(70)
        self.dilation_spinbox.setRange(0, 50)
        self.dilation_spinbox.setValue(5)
        self.dilation_spinbox.setToolTip(self.tr("Adjusts how much the text mask is expanded. Increase this if black spots or text traces remain."))
