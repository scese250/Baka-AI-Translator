...
class ComicTranslateUI(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Baka AI Translator")
    ...
    def _create_main_content(self):
        ...
        self.text_class_dropdown = MComboBox().small()
        self.text_class_dropdown.setToolTip(self.tr("Text Class"))
        
        # We store the internal key as userData if possible, or mapping
        # MComboBox basically wraps QComboBox.
        # Let's just add items and manage mapping in controller or here.
        self.class_mapping = {
            self.tr("Bubble Text"): "text_bubble",
            self.tr("Free Text"): "text_free",
            self.tr("Sound Effect"): "text_sfx",
            self.tr("Narration"): "text_narration",
            self.tr("Inside Black Bubble"): "text_inside_black_bubble"
        }
        self.text_class_dropdown.addItems(list(self.class_mapping.keys()))
        self.text_class_dropdown.setFixedWidth(120)

        font_settings_layout.addWidget(self.text_class_dropdown)
        ...
        settings = QSettings("BakaAI", "BakaAITranslator")
        ...
        font_label = MDivider(self.tr("Change Font"))
        right_layout.addWidget(font_label)
        right_layout.addWidget(self.font_dropdown)
