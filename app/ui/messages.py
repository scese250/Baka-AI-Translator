...
class Messages:
    ...
    @staticmethod
    def show_gemini_cookies_error(parent, browser_name: str = "Firefox"):
        MMessage.error(
            text=QCoreApplication.translate(
                "Messages",
                f"Could not find Google Gemini cookies in {browser_name}.\\n"
                f"Please:\\n"
                f"1. Open {browser_name} and log into gemini.google.com\\n"
                f"2. Close {browser_name} completely\\n"
                f"3. Click 'Grab Cookies' in Settings \u003e Credentials\\n"
                f"4. Try again"
            ),
            parent=parent,
            duration=None,
