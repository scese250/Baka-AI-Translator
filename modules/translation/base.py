...
DEFAULT_SYSTEM_PROMPT = """You are an expert translator who translates {source_lang} to {target_lang}. You pay attention to style, formality, idioms, slang etc and try to convey it in the way a {target_lang} speaker would understand.
...
class LLMTranslation(TranslationEngine):
    ...
    def get_system_prompt(self, source_lang: str, target_lang: str) -> str:
        ...
        """
        return DEFAULT_SYSTEM_PROMPT.format(source_lang=source_lang, target_lang=target_lang)
