...
class Translator:
    ...
    def _get_translator_key(self, localized_translator: str) -> str:
        ...
        """
        translator_map = {
            self.settings.ui.tr("Gemini-3.0-Pro"): "Gemini-3.0-Pro",
    ...
    def translate(self, blk_list: list[TextBlock], image: np.ndarray = None, extra_context: str = "", image_format: str = ".webp") -> list[TextBlock]:
        """
        ...
        if self.is_llm_engine:
            ...
            return self.engine.translate(blk_list, image, extra_context, image_format)
        else:
